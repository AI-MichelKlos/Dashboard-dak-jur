...
QUERIES = {
    "unemployment_total": (
        ...
        "&hierarchy._omrade=/&hierarchy._ygrpi09=/"
    ...
    "activation": (
        ...
        "&hierarchy._omrade=/&hierarchy._akassedp=/"
        "&hierarchy._tilb_2ptv=*&format=json"
    ),
    "notices": (
        "data/y25i05?mgroup.*=*&period.M=latest:14"
        "&hierarchy._omrade=/&format=json"
    ),
    "work_sharing": (
        "data/y25i06?mgroup.*=*&period.M=latest:14"
        "&hierarchy._omrade=/&hierarchy._var13uger=*&format=json"
    ),
    "recruitment": (
        "data/y25i14?mgroup.*=*&period.M=latest:8"
        "&hierarchy._omrade=/&hierarchy._escostar_rs=/&format=json"
    ),
    "graduates_total": (
        "data/y01dia02?mgroup.*=*&period.M=latest:14"
        "&hierarchy._omrade=/&hierarchy._akassedp=/&format=json"
    ),
    "graduates_akasser": (
